...
\ifthenelse{\(\value{num}=1\)}{\includepdf[pages={1},link=true]{./../Evidencias/01_MarcoNuno_TituloDoctorado.pdf}}{}
%\includepdf[pages=1-,link=true]{./../Evidencias/sensors-18-02202-v2.pdf}
\ifthenelse{\(\value{num}=1\)}{\includepdf[pages={1},link=true]{./../Evidencias/19_AsignacionProyectoPROMEP.pdf}}{}
